...
#ifndef AI_NETWORK_1654513533255_H
#define AI_NETWORK_1654513533255_H
#pragma once

#include "network_1654513533255_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_1654513533255_MODEL_NAME          "network_1654513533255"
#define AI_NETWORK_1654513533255_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_NETWORK_1654513533255_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_NETWORK_1654513533255_IN_NUM        (1)
#define AI_NETWORK_1654513533255_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 90, 3, 1, 1, NULL), \
}
#define AI_NETWORK_1654513533255_IN_SIZE { \
  AI_NETWORK_1654513533255_IN_1_SIZE, \
}
#define AI_NETWORK_1654513533255_IN_SIZE_BYTES { \
  AI_NETWORK_1654513533255_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_1654513533255_IN_1_HEIGHT      (90)
#define AI_NETWORK_1654513533255_IN_1_WIDTH       (3)
#define AI_NETWORK_1654513533255_IN_1_CHANNEL     (1)
#define AI_NETWORK_1654513533255_IN_1_SIZE        (90 *  3 *  1)
#define AI_NETWORK_1654513533255_IN_1_SIZE_BYTES  (AI_NETWORK_1654513533255_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_NETWORK_1654513533255_OUT_NUM       (1)
#define AI_NETWORK_1654513533255_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 6, 1, NULL), \
}
#define AI_NETWORK_1654513533255_OUT_SIZE { \
  AI_NETWORK_1654513533255_OUT_1_SIZE, \
}
#define AI_NETWORK_1654513533255_OUT_SIZE_BYTES { \
  AI_NETWORK_1654513533255_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_1654513533255_OUT_1_CHANNEL     (6)
#define AI_NETWORK_1654513533255_OUT_1_SIZE        (6)
#define AI_NETWORK_1654513533255_OUT_1_SIZE_BYTES  (AI_NETWORK_1654513533255_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_NETWORK_1654513533255_N_NODES (7)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_1654513533255
 ...
 * @ref ai_network_1654513533255_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_1654513533255_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_NETWORK_1654513533255_*
 * defines into file @ref network_1654513533255.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_1654513533255_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_1654513533255_H */
