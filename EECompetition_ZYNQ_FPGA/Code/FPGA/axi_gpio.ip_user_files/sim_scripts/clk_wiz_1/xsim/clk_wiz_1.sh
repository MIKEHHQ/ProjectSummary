...
#
# Generated by Vivado on Fri Nov 12 20:04:47 +0800 2021
...
simulate()
{
  xsim clk_wiz_1 -key {Behavioral:sim_1:Functional:clk_wiz_1} -tclbatch cmd.tcl -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
